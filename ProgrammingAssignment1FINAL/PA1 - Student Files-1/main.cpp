...
int main()
{
  try
  {
    ...
    GroceryList thingsToBuy = { { "soda"    },
                                { "bananas" },
                                { "milk"    },
                                { "candy"   } };
    
    thingsToBuy.moveToTop( { "milk" } );
    ...
    GroceryList roommatesList = { { "ramen", "Shin"   },
                                  { "ramen", "Buldak" },
                                  { "chips", "Hot Cheetos"       },
                                  { "milk"            },
                                  { "cheese"           } };
    ...
    if( thingsToBuy != roommatesList ) thingsToBuy += roommatesList;
    thingsToBuy.insert( { "milk", "Almond" }, thingsToBuy.find( { "candy" } ) );
    ...
    GroceryList expectedResults = {{ "milk" },
                                   { "soda" },
                                   { "bananas" },
                                   { "Almond", "milk" },
                                   { "candy" },
