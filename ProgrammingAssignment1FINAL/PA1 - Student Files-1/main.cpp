...
int main()
{
  try
  {
    ...
    GroceryList thingsToBuy = { { "Coca Cola", "Soda" },
                                { "Bananas" },
                                { "Milk" },
                                { "Lays", "Chips" } };
    
    thingsToBuy.moveToTop( { "Lays", "Chips" } );
    ...
    GroceryList roommatesList = { { "Shin", "Ramen" },
                                  { "Buldak", "Ramen" },
    ...
    if( thingsToBuy != roommatesList ) thingsToBuy += roommatesList;
    thingsToBuy.insert( { "Almond", "Milk" }, thingsToBuy.find( { "Milk" } ) );
    thingsToBuy.remove( { "Bread" } );
    ...
    GroceryList expectedResults = {{ "Lays", "Chips" },
                                  { "Coca Cola", "Soda" },
                                  { "Bananas" },
                                  { "Almond", "Milk" },
                                  { "Milk" },
